...
class ControleurGererPanier{
	...
	*/
	function confirmerCommande()
		{
			try{
			$prenom =$_REQUEST['prenom'];$nom =$_REQUEST['nom'];$rue=$_REQUEST['rue'];$ville =$_REQUEST['ville'];$cp=$_REQUEST['cp'];$mail=$_REQUEST['mail'];
			$msgErreurs = $this->getErreursSaisieCommande($prenom,$nom,$rue,$ville,$cp,$mail);
			...
			else
			{
				...
				$this->modeleFront->creerCommande($prenom,$nom,$rue,$cp,$ville,$mail, $lesIdProduits );
	...
	function supprimerProduitPanier()
	{
		if(isset($_GET['produit'])){
			$pro =array_search($_GET['produit'],$_SESSION['produits']);
			unset($_SESSION['produits'][$pro]);
		}
		$this->voirPanier();
	}
	...
	*/
	function getErreursSaisieCommande($prenom,$nom,$rue,$ville,$cp,$mail)
	{
		$lesErreurs = array();
		if($prenom=="")
		{
